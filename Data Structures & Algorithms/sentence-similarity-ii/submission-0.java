class Solution {
    public boolean areSentencesSimilarTwo(String[] sentence1, String[] sentence2, List<List<String>> similarPairs) {
        ...
        for(List<String> similarPair : similarPairs) {
            ...
            if(rep1.equals(rep2)) {
                if(!disjointSets.containsKey(rep1)) {
                    disjointSets.put(rep1, new HashSet());
                }
                disjointSets.get(rep1).add(word1);
                disjointSets.get(rep1).add(word2);
            }
        }
    ...
    private void union(Map<String, String> parentMap, String word1, String word2) {
        String word1Rep = parentMap.get(word1);
        String word2Rep = parentMap.get(word2);
        parentMap.put(word1Rep, word2Rep);
    }
}
